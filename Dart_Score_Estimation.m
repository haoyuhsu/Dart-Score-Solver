...
backgroundImage = imresize(im2double(imread('./image/no_dart.jpg')), scale);

fprintf('Select Dart Image..\n');
dartImage = imresize(im2double(imread('./image/one_dart.jpg')), scale);
...
dart = findForeground(dartImage, backgroundImage, masks, type);
